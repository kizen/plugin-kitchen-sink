// Kitchen Sink App · Page · Business Explorer · paginate
//
// Fired by either pager <form data-script="paginate"> submit (Prev/Next), which carry the
// current tab/search/ordering plus the target page number as hidden inputs. Identical
// parse-and-render logic to search.js — see script.js for the shared core this duplicates.
